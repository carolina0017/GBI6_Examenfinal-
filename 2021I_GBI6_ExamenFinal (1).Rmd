...
descr(cancer_mama) %>% tab_df(title = "Cancer de MAMA y su nivel de expresión de los diferentes genes",
                              file= "This Pc:/Documents/GBI6_ExamenFinal/results/mRNA_expr_summary.doc") 
```
...
# Las tablas nos dan información acerca de los niveles de expresión, del tipo de cancer del que se trata y los números de muestra de cada cancer.
```
...
ggsave("resultados/boxplot3.png", width = 6, height = 8, dpi = 300)
...
ggsave("resultados/regresion11.pdf", width = 6, height = 8, dpi = 300)
```
...
# Los resultados obtenidos anteriormente nos muestran los niveles de expresion del cancer renal, en donde se puede observar que la mediana nos da un resultado aproximado de 1 
```
